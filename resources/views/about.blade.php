...
@section('content')
		...
		<section id="facilities" class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
			
			<div class="container text-center">
				
				<h4 class="section-heading">-facilities-</h4>

				<h2 class="heading">REASONS TO JOIN US THIS SUMMER</h2>
				...
				<div id="reasons">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<h2 class="heading">Team & Individual Sports</h2>

							<p>Nullam vel pellentesque tortor, nec ornare enim.</p>

						</div>

						<div class="col-md-3 col-sm-6 col-xs-12">
							
							<a href="" class="fa fa-music" aria-hidden="true"></a>

							<h2 class="heading">Performing & Creative Art</h2>
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<a href="" class="fa fa-tint" aria-hidden="true"></a>

							<h2 class="heading">Waterfront Activities</h2>
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<a href="" class="fa fa-suitcase" aria-hidden="true"></a>

							<h2 class="heading">Special Events & Treaps</h2>
